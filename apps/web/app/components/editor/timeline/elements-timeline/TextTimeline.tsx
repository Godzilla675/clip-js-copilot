            ...
            {textElements.map((clip, index) => (
                <div key={clip.id} className="bg-green-500">
                    <div
                        ...
                        className={`absolute border border-gray-500 border-opacity-50 rounded-md top-2 h-12 rounded bg-[#27272A] text-white text-sm flex items-center justify-center cursor-pointer ${activeElement === 'text' && activeElementIndex === index ? 'bg-[#3F3F46] border-blue-500' : ''}`}
                        style={{
